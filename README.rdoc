...
* ImpactJS[http://impactjs.com/], a proprietary Javascript game framework for building HTML5 games.  It lets you create and manipulate entities that have both the Box2D physics, as well as custom rendering properties. ImpactJS has become quite popular in gaming, but it is closed and requires a paid license.

* boxbox[http://incompl.github.com/boxbox/], which I haven't tried yet.  It is an open-source JS project with a simplified API that wraps both Box2D and rendering. It's not clear whether it exposes you to the full methods and attributes of the Box2DWeb library.
