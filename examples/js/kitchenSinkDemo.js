...
KitchenSinkDemo = (function() {
  ...
  function KitchenSinkDemo(canvas, debugCanvas, statsCanvas) {
    var customCircle, customRectangle, height, i, radius, width;
    this.world = new EaselBoxWorld(this, frameRate, canvas, debugCanvas, gravityX, gravityY, pixelsPerMeter);
    this.world.addEntity(new EaselBoxCircle(radius = 30), 'dynamic', {
      xPixels: canvas.width / 2,
      yPixels: canvas.height / 2,
      angleRadians: 45,
      angularVelRadians: 2
    });
    this.world.addEntity(new EaselBoxCircle(radius = 20, {
    ...
    for (i = 0; i <= 5; i++) {
      this.world.addEntity(new EaselBoxCircle(radius = 4, {
    ...
    this.world.addEntity(customCircle, 'dynamic', {
      xPixels: canvas.width * 3 / 4,
      yPixels: canvas.height * 1 / 4,
      angularVelRadians: -1
    });
    this.world.addEntity(new EaselBoxRectangle(width = 30, height = 20), 'dynamic', {
    ...
    this.world.addEntity(customRectangle, 'dynamic', {
